 ...
 * specified min and max (prefixed by "row_"). The column families will be "foo"
 * and column qualifiers will be "1". The values will be random byte arrays of a
 * specified size.
 */
public class RandomBatchWriter {
    ...
    /**
     * Creates a mutation on a specified row with column family "foo", column
     * qualifier "1", specified visibility, and a random value of specified
     * size.
     *
